const Service = require("../services/KeuanganKeluarService");
...
exports.update = async (req, res) => {
 ...
 exports.deleteKeuanganKeluar = async (req, res) => {
   const { code, message, render } = await Service.hapusKeuanganKeluar(
     req.traceId,
     req.params
   );
   if (render) {
