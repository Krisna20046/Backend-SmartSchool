const Service = require("../services/PeminjamanFasilitasService");
...
exports.show = async (req, res) => {
 ...
 exports.deletePeminjamanFasilitas = async (req, res) => {
   const { code, message, render } = await Service.hapusPeminjamanFasilitas(
     req.traceId,
     req.params
   );
   if (render) {
